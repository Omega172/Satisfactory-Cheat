...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass BPW_Sign1x1_1.BPW_Sign1x1_0_C
	 * Size -> 0x003F (FullSize[0x0468] - InheritedSize[0x0429])
	 */
	class UBPW_Sign1x1_0_C : public UBPW_SignPrefab_C
	{
	public:
		unsigned char                                              UnknownData_AHDE[0x7];                                   // 0x0429(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class UImage*                                              mIconBG;                                                 // 0x0450(0x0008) BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
	...
	public:
		void ExecuteUbergraph_BPW_Sign1x1_1(int32_t EntryPoint);
