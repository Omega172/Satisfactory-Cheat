...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_QXHK[0x4];                                   // 0x02B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_BJE5[0x4];                                   // 0x02EC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_PJA3[0x18];                                  // 0x02F8(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_TO42[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_1FPO[0x68];                                  // 0x01C8(0x0068) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_5KSE[0x8];                                   // 0x0568(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_NHQC[0x1];                                   // 0x0582(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_A2YM[0x44];                                  // 0x0584(0x0044) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_RX2M[0x18];                                  // 0x05D8(0x0018) MISSED OFFSET (PADDING)
