...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass BPW_Sign2x1_10.BPW_Sign2x1_9_C
	 * Size -> 0x002F (FullSize[0x0458] - InheritedSize[0x0429])
	 */
	class UBPW_Sign2x1_9_C : public UBPW_SignPrefab_C
	{
	public:
		unsigned char                                              UnknownData_QR57[0x7];                                   // 0x0429(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
