...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_UnlockInfoOnly.BP_UnlockInfoOnly_C.GetCost
	 */
	struct UBP_UnlockInfoOnly_C_GetCost_Params
	{
	public:
		...
		unsigned char                                              UnknownData_0O8C[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		TArray<struct FItemAmount>                                 cost;                                                    // 0x0008(0x0010)  (Parm, OutParm)
	};

	/**
	 * Function BP_UnlockInfoOnly.BP_UnlockInfoOnly_C.GetStingerWidgetRewardData
	 */
	struct UBP_UnlockInfoOnly_C_GetStingerWidgetRewardData_Params
	{	};

	/**
	 * Function BP_UnlockInfoOnly.BP_UnlockInfoOnly_C.GetUnlockRewardWidgets
	 */
	struct UBP_UnlockInfoOnly_C_GetUnlockRewardWidgets_Params
	{
	public:
	...
	/**
	 * Function BP_UnlockInfoOnly.BP_UnlockInfoOnly_C.GetUnlockDataStruct
	 */
	struct UBP_UnlockInfoOnly_C_GetUnlockDataStruct_Params
	{
	public:
