...
namespace CG
{
	...
	public:
		...
		class UFGFactoryConnectionComponent*                       Output3;                                                 // 0x0730(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash
		class UFGFactoryConnectionComponent*                       Output2;                                                 // 0x0738(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void ExecuteUbergraph_Build_ConveyorAttachmentSplitterProgrammable(int32_t EntryPoint);
