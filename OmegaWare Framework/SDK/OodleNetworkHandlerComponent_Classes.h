...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_KGYA[0x2];                                   // 0x0082(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_XOT5[0x7];                                   // 0x0099(0x0007) MISSED OFFSET (PADDING)
