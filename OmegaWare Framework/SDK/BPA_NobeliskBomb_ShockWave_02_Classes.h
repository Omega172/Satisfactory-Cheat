...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_OXAT[0x8];                                   // 0x0348(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_BJU2[0x7];                                   // 0x0779(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
