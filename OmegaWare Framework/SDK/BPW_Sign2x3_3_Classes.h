...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass BPW_Sign2x3_3.BPW_Sign2x3_2_C
	 * Size -> 0x0037 (FullSize[0x0460] - InheritedSize[0x0429])
	 */
	class UBPW_Sign2x3_2_C : public UBPW_SignPrefab_C
	{
	public:
		unsigned char                                              UnknownData_NP1Q[0x7];                                   // 0x0429(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class URichTextBlock*                                      mLabel;                                                  // 0x0450(0x0008) BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		class URichTextBlock*                                      mName;                                                   // 0x0458(0x0008) BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
