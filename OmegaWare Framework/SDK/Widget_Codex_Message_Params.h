...
namespace CG
{
	...
	{
	public:
		class UClass*                                              contentClass;                                            // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_YV6I[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
