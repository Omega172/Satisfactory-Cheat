...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass BPW_Sign2x1_13.BPW_Sign2x1_12_C
	 * Size -> 0x002F (FullSize[0x0458] - InheritedSize[0x0429])
	 */
	class UBPW_Sign2x1_12_C : public UBPW_SignPrefab_C
	{
	public:
		unsigned char                                              UnknownData_1942[0x7];                                   // 0x0429(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class UImage*                                              mOtherIcon;                                              // 0x0450(0x0008) BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
