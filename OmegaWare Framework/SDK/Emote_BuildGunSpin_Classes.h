...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Emote_BuildGunSpin.Emote_BuildGunSpin_C
	 * Size -> 0x0008 (FullSize[0x0060] - InheritedSize[0x0058])
	 */
	class UEmote_BuildGunSpin_C : public UFGEmote
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_Emote_BuildGunSpin(int32_t EntryPoint);
