...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass BPA_GeneratorBiomass.BPA_GeneratorBiomass_C
	 * Size -> 0x0588 (FullSize[0x1228] - InheritedSize[0x0CA0])
	 */
	class UBPA_GeneratorBiomass_C : public UFGFAnimInstanceFactory
	{
	public:
		struct FPointerToUberGraphFrame                            UberGraphFrame;                                          // 0x0CA0(0x0008) ZeroConstructor, Transient, DuplicateTransient
		struct UBPA_GeneratorBiomass_C_FAnimBlueprintGeneratedMutableData __AnimBlueprintMutables;                                 // 0x0CA8(0x0008) HasGetValueTypeHash
		...
		class UParticleSystemComponent*                            mBiogenVfx_01;                                           // 0x1210(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash
		class UParticleSystemComponent*                            mBiogenVfx_02;                                           // 0x1218(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash
		class UParticleSystemComponent*                            mFunnelVfx;                                              // 0x1220(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash

	public:
		void AnimGraph(struct FPoseLink* AnimGraph);
		void AnimNotify_BioGenEnteredFunnelPoweredState();
		void AnimNotify_BioGenEnteredFunnelShutdownState();
		void ExecuteUbergraph_BPA_GeneratorBiomass(int32_t EntryPoint);
