...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_NobeliskNuke.BP_NobeliskNuke_C
	 * Size -> 0x0038 (FullSize[0x0658] - InheritedSize[0x0620])
	 */
	class ABP_NobeliskNuke_C : public AFGStickyExplosive
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_NobeliskNuke(int32_t EntryPoint);
