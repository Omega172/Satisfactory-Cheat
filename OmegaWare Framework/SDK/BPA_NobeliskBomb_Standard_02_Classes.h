...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass BPA_NobeliskBomb_Standard_02.BPA_NobeliskBomb_Standard_02_C
	 * Size -> 0x0440 (FullSize[0x0788] - InheritedSize[0x0348])
	 */
	class UBPA_NobeliskBomb_Standard_02_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_105A[0x8];                                   // 0x0348(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_YA05[0x7];                                   // 0x0779(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_BPA_NobeliskBomb_Standard_02(int32_t EntryPoint);
