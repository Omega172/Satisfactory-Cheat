...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Rebar_Steel.BP_Rebar_Steel_C.ReceiveBeginPlay
	 */
	struct ABP_Rebar_Steel_C_ReceiveBeginPlay_Params
	{	};

	/**
	 * Function BP_Rebar_Steel.BP_Rebar_Steel_C.PlayAttachEffect
	 */
	struct ABP_Rebar_Steel_C_PlayAttachEffect_Params
	{	};

	/**
	 * Function BP_Rebar_Steel.BP_Rebar_Steel_C.ReceiveTick
	 */
	struct ABP_Rebar_Steel_C_ReceiveTick_Params
	{
	public:
	...
	/**
	 * Function BP_Rebar_Steel.BP_Rebar_Steel_C.ReceiveHit
	 */
	struct ABP_Rebar_Steel_C_ReceiveHit_Params
	{
	public:
		...
		unsigned char                                              UnknownData_41J2[0x7];                                   // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_Rebar_Steel.BP_Rebar_Steel_C.Shot Player
	 */
	struct ABP_Rebar_Steel_C_ShotPlayer_Params
	{
	public:
	...
	/**
	 * Function BP_Rebar_Steel.BP_Rebar_Steel_C.ExecuteUbergraph_BP_Rebar_Steel
	 */
	struct ABP_Rebar_Steel_C_ExecuteUbergraph_BP_Rebar_Steel_Params
	{
	public:
