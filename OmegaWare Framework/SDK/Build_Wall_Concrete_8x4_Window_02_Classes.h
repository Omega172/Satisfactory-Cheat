...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Build_Wall_Concrete_8x4_Window_02.Build_Wall_Concrete_8x4_Window_02_C
	 * Size -> 0x0008 (FullSize[0x0618] - InheritedSize[0x0610])
	 */
	class ABuild_Wall_Concrete_8x4_Window_02_C : public AFGBuildableWallLightweight
	{
	public:
