...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_QQAS[0x8];                                   // 0x0348(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_BAUZ[0x6];                                   // 0x035A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5Q67[0x3];                                   // 0x04A1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
