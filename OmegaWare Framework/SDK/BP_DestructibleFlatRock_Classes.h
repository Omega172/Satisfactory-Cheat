...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_DestructibleFlatRock.BP_DestructibleFlatRock_C
	 * Size -> 0x0018 (FullSize[0x0378] - InheritedSize[0x0360])
	 */
	class ABP_DestructibleFlatRock_C : public AFGDestructibleActor
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_DestructibleFlatRock(int32_t EntryPoint);
