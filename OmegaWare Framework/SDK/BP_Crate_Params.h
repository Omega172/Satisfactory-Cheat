...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Crate.BP_Crate_C.GetLookAtDecription
	 */
	struct ABP_Crate_C_GetLookAtDecription_Params
	{
	public:
	...
	/**
	 * Function BP_Crate.BP_Crate_C.GetDefaultRepresentationColor
	 */
	struct ABP_Crate_C_GetDefaultRepresentationColor_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_OFRG[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
