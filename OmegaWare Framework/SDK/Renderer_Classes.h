...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_3ROG[0x3];                                   // 0x0571(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_4EH7[0xC];                                   // 0x0584(0x000C) MISSED OFFSET (PADDING)
