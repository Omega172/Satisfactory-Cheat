...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Char_SpitterForestRedSmall.Char_SpitterForestRedSmall_C
	 * Size -> 0x0010 (FullSize[0x0A90] - InheritedSize[0x0A80])
	 */
	class AChar_SpitterForestRedSmall_C : public ABP_Creature_C
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_Char_SpitterForestRedSmall(int32_t EntryPoint);
