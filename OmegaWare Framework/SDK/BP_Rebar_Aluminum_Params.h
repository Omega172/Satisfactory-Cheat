...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Rebar_Aluminum.BP_Rebar_Aluminum_C.ReceiveBeginPlay
	 */
	struct ABP_Rebar_Aluminum_C_ReceiveBeginPlay_Params
	{	};

	/**
	 * Function BP_Rebar_Aluminum.BP_Rebar_Aluminum_C.PlayAttachEffect
	 */
	struct ABP_Rebar_Aluminum_C_PlayAttachEffect_Params
	{	};

	/**
	 * Function BP_Rebar_Aluminum.BP_Rebar_Aluminum_C.ReceiveTick
	 */
	struct ABP_Rebar_Aluminum_C_ReceiveTick_Params
	{
	public:
	...
	/**
	 * Function BP_Rebar_Aluminum.BP_Rebar_Aluminum_C.ReceiveHit
	 */
	struct ABP_Rebar_Aluminum_C_ReceiveHit_Params
	{
	public:
		...
		unsigned char                                              UnknownData_I4P6[0x7];                                   // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_Rebar_Aluminum.BP_Rebar_Aluminum_C.Shot Player
	 */
	struct ABP_Rebar_Aluminum_C_ShotPlayer_Params
	{
	public:
	...
	/**
	 * Function BP_Rebar_Aluminum.BP_Rebar_Aluminum_C.ExecuteUbergraph_BP_Rebar_Aluminum
	 */
	struct ABP_Rebar_Aluminum_C_ExecuteUbergraph_BP_Rebar_Aluminum_Params
	{
	public:
