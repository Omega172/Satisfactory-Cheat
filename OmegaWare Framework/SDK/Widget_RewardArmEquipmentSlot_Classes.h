...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_KVPD[0x8];                                   // 0x0418(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Construct();
		void ExecuteUbergraph_Widget_RewardArmEquipmentSlot(int32_t EntryPoint);
