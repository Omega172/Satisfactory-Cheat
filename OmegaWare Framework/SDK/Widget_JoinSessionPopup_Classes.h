...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass Widget_JoinSessionPopup.Widget_JoinSessionPopup_C
	 * Size -> 0x0018 (FullSize[0x02A8] - InheritedSize[0x0290])
	 */
	class UWidget_JoinSessionPopup_C : public UFGPopupWidgetContent
	{
	public:
	...
	public:
		...
		void Construct();
		void Destruct();
		void OnJoinSessionStateUpdated(EJoinSessionState NewState);
		void ExecuteUbergraph_Widget_JoinSessionPopup(int32_t EntryPoint);
