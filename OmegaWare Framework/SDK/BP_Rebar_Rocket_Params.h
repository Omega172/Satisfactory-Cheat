...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Rebar_Rocket.BP_Rebar_Rocket_C.PlayAttachEffect
	 */
	struct ABP_Rebar_Rocket_C_PlayAttachEffect_Params
	{	};

	/**
	 * Function BP_Rebar_Rocket.BP_Rebar_Rocket_C.ReceiveTick
	 */
	struct ABP_Rebar_Rocket_C_ReceiveTick_Params
	{
	public:
	...
	/**
	 * Function BP_Rebar_Rocket.BP_Rebar_Rocket_C.ReceiveHit
	 */
	struct ABP_Rebar_Rocket_C_ReceiveHit_Params
	{
	public:
		...
		unsigned char                                              UnknownData_KLID[0x7];                                   // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_Rebar_Rocket.BP_Rebar_Rocket_C.Shot Player
	 */
	struct ABP_Rebar_Rocket_C_ShotPlayer_Params
	{
	public:
	...
	/**
	 * Function BP_Rebar_Rocket.BP_Rebar_Rocket_C.ReceiveBeginPlay
	 */
	struct ABP_Rebar_Rocket_C_ReceiveBeginPlay_Params
	{	};

	/**
	 * Function BP_Rebar_Rocket.BP_Rebar_Rocket_C.ExecuteUbergraph_BP_Rebar_Rocket
	 */
	struct ABP_Rebar_Rocket_C_ExecuteUbergraph_BP_Rebar_Rocket_Params
	{
	public:
