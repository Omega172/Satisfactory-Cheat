...
namespace CG
{
	...
	public:
		...
		class UFGPipeConnectionComponentHyper*                     PipeHyperSupportSnap;                                    // 0x0628(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void ExecuteUbergraph_Build_PipeHyperSupport(int32_t EntryPoint);
