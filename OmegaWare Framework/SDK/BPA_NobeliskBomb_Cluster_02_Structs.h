...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * ScriptStruct BPA_NobeliskBomb_Cluster_02.BPA_NobeliskBomb_Cluster_02_C.AnimBlueprintGeneratedConstantData
	 * Size -> 0x0127 (FullSize[0x0128] - InheritedSize[0x0001])
	 */
	struct UBPA_NobeliskBomb_Cluster_02_C_FAnimBlueprintGeneratedConstantData : public FAnimBlueprintConstantData
	{
	public:
		unsigned char                                              UnknownData_2KQH[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SOQ0[0x1];                                   // 0x005B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	/**
	 * ScriptStruct BPA_NobeliskBomb_Cluster_02.BPA_NobeliskBomb_Cluster_02_C.AnimBlueprintGeneratedMutableData
	 * Size -> 0x0000 (FullSize[0x0001] - InheritedSize[0x0001])
	 */
	struct UBPA_NobeliskBomb_Cluster_02_C_FAnimBlueprintGeneratedMutableData : public FAnimBlueprintMutableData
	{	};
