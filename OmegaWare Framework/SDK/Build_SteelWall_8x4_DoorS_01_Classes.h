...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Build_SteelWall_8x4_DoorS_01.Build_SteelWall_8x4_DoorS_01_C
	 * Size -> 0x0017 (FullSize[0x0690] - InheritedSize[0x0679])
	 */
	class ABuild_SteelWall_8x4_DoorS_01_C : public ABUILD_SingleDoor_Base_01_C
	{
	public:
		unsigned char                                              UnknownData_0RNY[0x7];                                   // 0x0679(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
