...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_8VBI[0x4];                                   // 0x0074(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_W9HI[0x2];                                   // 0x009E(0x0002) MISSED OFFSET (PADDING)
