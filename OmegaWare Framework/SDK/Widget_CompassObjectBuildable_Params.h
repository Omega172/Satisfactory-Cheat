...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function Widget_CompassObjectBuildable.Widget_CompassObjectBuildable_C.UpdateVisibility
	 */
	struct UWidget_CompassObjectBuildable_C_UpdateVisibility_Params
	{	};
