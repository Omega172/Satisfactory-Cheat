...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_TZC3[0x4];                                   // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_X70X[0x7];                                   // 0x0061(0x0007) MISSED OFFSET (PADDING)
	};
