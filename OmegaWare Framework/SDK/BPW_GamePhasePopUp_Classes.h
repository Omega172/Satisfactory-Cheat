...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass BPW_GamePhasePopUp.BPW_GamePhasePopUp_C
	 * Size -> 0x0020 (FullSize[0x02A0] - InheritedSize[0x0280])
	 */
	class UBPW_GamePhasePopUp_C : public UUserWidget
	{
	public:
		...
		class UObject*                                             mIconTexture;                                            // 0x0298(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash

	public:
		void SetStingerContent(EGamePhase mGamePhase);
		void Construct();
		void OnGamePhaseCompleted(EGamePhase gamePhase);
		void ExecuteUbergraph_BPW_GamePhasePopUp(int32_t EntryPoint);
