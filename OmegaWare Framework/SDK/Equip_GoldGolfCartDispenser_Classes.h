...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Equip_GoldGolfCartDispenser.Equip_GoldGolfCartDispenser_C
	 * Size -> 0x0048 (FullSize[0x04E8] - InheritedSize[0x04A0])
	 */
	class AEquip_GoldGolfCartDispenser_C : public AFGGolfCartDispenser
	{
	public:
		...
		unsigned char                                              UnknownData_ZHU6[0x7];                                   // 0x04D9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_Equip_GoldGolfCartDispenser(int32_t EntryPoint);
