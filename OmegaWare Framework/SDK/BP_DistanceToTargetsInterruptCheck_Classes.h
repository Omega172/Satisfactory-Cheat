...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_DistanceToTargetsInterruptCheck.BP_DistanceToTargetsInterruptCheck_C
	 * Size -> 0x0008 (FullSize[0x0060] - InheritedSize[0x0058])
	 */
	class UBP_DistanceToTargetsInterruptCheck_C : public UFGCreatureInterruptTest
	{
	public:
