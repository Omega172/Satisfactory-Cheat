...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_3DL1[0x8];                                   // 0x04A0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_J75K[0x10];                                  // 0x04C0(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_EIZG[0x3];                                   // 0x0069(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_B1DS[0x14];                                  // 0x0074(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
