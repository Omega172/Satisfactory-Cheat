...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass BPW_Sign2x3_2.BPW_Sign2x3_1_C
	 * Size -> 0x0027 (FullSize[0x0450] - InheritedSize[0x0429])
	 */
	class UBPW_Sign2x3_1_C : public UBPW_SignPrefab_C
	{
	public:
		unsigned char                                              UnknownData_995H[0x7];                                   // 0x0429(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
