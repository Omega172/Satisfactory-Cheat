...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass BPA_NobeliskBomb_Gas_02.BPA_NobeliskBomb_Gas_02_C
	 * Size -> 0x0439 (FullSize[0x0781] - InheritedSize[0x0348])
	 */
	class UBPA_NobeliskBomb_Gas_02_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_6ITG[0x8];                                   // 0x0348(0x0008) Fix Super Size
		...
		class UNiagaraComponent*                                   VFX_Idle;                                                // 0x0778(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash
		bool                                                       Armed;                                                   // 0x0780(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash

	public:
		void AnimGraph(struct FPoseLink* AnimGraph);
		void OnMagazineHidden();
		void PlayStingerAnimation();
		void ExecuteUbergraph_BPA_NobeliskBomb_Gas_02(int32_t EntryPoint);
