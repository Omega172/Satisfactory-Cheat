...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_YF4K[0x8];                                   // 0x0348(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_FSCF[0x4];                                   // 0x037C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ZP6W[0x8];                                   // 0x03F8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_RBS2[0x7];                                   // 0x1589(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_9JCT[0x7];                                   // 0x15B1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
