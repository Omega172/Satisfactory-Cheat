...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x71E141BE0
	 * 		Name   -> Function Landscape.LandscapeProxy.SetVirtualTextureRenderPassType
	...
	void ALandscapeProxy::SetVirtualTextureRenderPassType(ERuntimeVirtualTextureMainPassType InType)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Landscape.LandscapeProxy.SetVirtualTextureRenderPassType");
	 ...
	 * Function:
	 * 		RVA    -> 0x71E141800
	 * 		Name   -> Function Landscape.LandscapeProxy.GetLandscapeActor
	...
	class ALandscape* ALandscapeProxy::GetLandscapeActor()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Landscape.LandscapeProxy.GetLandscapeActor");
	 ...
	 * Function:
	 * 		RVA    -> 0x71E0E9940
	 * 		Name   -> Function Landscape.Landscape.RenderHeightmap
	...
	void ALandscape::RenderHeightmap(const struct FTransform& InWorldTransform, const struct FBox2D& InExtents, class UTextureRenderTarget2D* OutRenderTarget)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Landscape.Landscape.RenderHeightmap");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ULandscapeLODStreamingProxy_DEPRECATED.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* ULandscapeLODStreamingProxy_DEPRECATED::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class Landscape.LandscapeLODStreamingProxy_DEPRECATED");
		return ptr;
	}
	 ...
	 * Function:
	 * 		RVA    -> 0x71E0E9B80
	 * 		Name   -> Function Landscape.LandscapeComponent.SetLODBias
	 * 		Flags  -> (Final, RequiredAPI, Native, Public, BlueprintCallable)
	 * Parameters:
	...
	void ULandscapeComponent::SetLODBias(int32_t InLODBias)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Landscape.LandscapeComponent.SetLODBias");
	 ...
	 * Function:
	 * 		RVA    -> 0x71E0E9AF0
	 * 		Name   -> Function Landscape.LandscapeComponent.SetForcedLOD
	 * 		Flags  -> (Final, RequiredAPI, Native, Public, BlueprintCallable)
	 * Parameters:
	...
	void ULandscapeComponent::SetForcedLOD(int32_t InForcedLOD)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Landscape.LandscapeComponent.SetForcedLOD");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ULandscapeNaniteComponent.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* ULandscapeNaniteComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class Landscape.LandscapeNaniteComponent");
		return ptr;
	}
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ALandscapeSplineMeshesActor.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* ALandscapeSplineMeshesActor::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class Landscape.LandscapeSplineMeshesActor");
		return ptr;
	}
