...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass BPW_Sign4x1_4.BPW_Sign4x1_3_C
	 * Size -> 0x001F (FullSize[0x0448] - InheritedSize[0x0429])
	 */
	class UBPW_Sign4x1_3_C : public UBPW_SignPrefab_C
	{
	public:
		unsigned char                                              UnknownData_JMF9[0x7];                                   // 0x0429(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
