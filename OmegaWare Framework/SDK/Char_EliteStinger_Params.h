...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function Char_EliteStinger.Char_EliteStinger_C.ReceiveDied
	 */
	struct AChar_EliteStinger_C_ReceiveDied_Params
	{	};

	/**
	 * Function Char_EliteStinger.Char_EliteStinger_C.NotifyOnTakeDamage
	 */
	struct AChar_EliteStinger_C_NotifyOnTakeDamage_Params
	{
	public:
		...
		unsigned char                                              UnknownData_2SEP[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_B6JJ[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
