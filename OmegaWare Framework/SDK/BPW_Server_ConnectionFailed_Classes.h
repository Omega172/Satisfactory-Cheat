...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass BPW_Server_ConnectionFailed.BPW_Server_ConnectionFailed_C
	 * Size -> 0x0028 (FullSize[0x02A8] - InheritedSize[0x0280])
	 */
	class UBPW_Server_ConnectionFailed_C : public UUserWidget
	{
	public:
		...
		class FScriptMulticastDelegate                             OnRetry;                                                 // 0x0298(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable

	public:
		void BndEvt__Button_Connect_K2Node_ComponentBoundEvent_0_OnClicked__DelegateSignature();
		void ExecuteUbergraph_BPW_Server_ConnectionFailed(int32_t EntryPoint);
