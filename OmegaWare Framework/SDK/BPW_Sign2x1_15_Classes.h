...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass BPW_Sign2x1_15.BPW_Sign2x1_14_C
	 * Size -> 0x001F (FullSize[0x0448] - InheritedSize[0x0429])
	 */
	class UBPW_Sign2x1_14_C : public UBPW_SignPrefab_C
	{
	public:
		unsigned char                                              UnknownData_R9CN[0x7];                                   // 0x0429(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
