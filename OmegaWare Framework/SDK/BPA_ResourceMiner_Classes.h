...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_7FCT[0x8];                                   // 0x0348(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_99W4[0x4];                                   // 0x042C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
