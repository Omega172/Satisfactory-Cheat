...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_DXR3[0x8];                                   // 0x0C60(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_DGDV[0x2C];                                  // 0x0C74(0x002C) MISSED OFFSET (PADDING)
