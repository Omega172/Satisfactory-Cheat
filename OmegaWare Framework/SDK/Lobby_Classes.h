...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_XLTG[0x1];                                   // 0x0398(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_DGKO[0x76];                                  // 0x039A(0x0076) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_R9JA[0x8];                                   // 0x0320(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_A8LV[0x7];                                   // 0x0371(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_6OMO[0x50];                                  // 0x0380(0x0050) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_UORY[0x8];                                   // 0x02F8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_3X3X[0x8];                                   // 0x0308(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_9RB4[0x3];                                   // 0x0311(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_QD6Z[0x68];                                  // 0x0438(0x0068) MISSED OFFSET (PADDING)
