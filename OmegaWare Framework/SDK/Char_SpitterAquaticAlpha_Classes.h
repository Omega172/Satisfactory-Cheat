...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Char_SpitterAquaticAlpha.Char_SpitterAquaticAlpha_C
	 * Size -> 0x0018 (FullSize[0x0A98] - InheritedSize[0x0A80])
	 */
	class AChar_SpitterAquaticAlpha_C : public ABP_Creature_C
	{
	public:
		struct FPointerToUberGraphFrame                            UberGraphFrame;                                          // 0x0A80(0x0008) ZeroConstructor, Transient, DuplicateTransient
		class UCapsuleComponent*                                   BodyCollisions;                                          // 0x0A88(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void ExecuteUbergraph_Char_SpitterAquaticAlpha(int32_t EntryPoint);
