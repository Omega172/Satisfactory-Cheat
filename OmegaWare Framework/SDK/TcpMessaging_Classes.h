...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_9AUV[0x7];                                   // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5LVL[0x7];                                   // 0x0059(0x0007) MISSED OFFSET (PADDING)
