...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * ScriptStruct BPA_NobeliskBomb_ShockWave_02.BPA_NobeliskBomb_ShockWave_02_C.AnimBlueprintGeneratedConstantData
	 * Size -> 0x0127 (FullSize[0x0128] - InheritedSize[0x0001])
	 */
	struct UBPA_NobeliskBomb_ShockWave_02_C_FAnimBlueprintGeneratedConstantData : public FAnimBlueprintConstantData
	{
	public:
		unsigned char                                              UnknownData_ZYGU[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		int32_t                                                    __IntProperty_72;                                        // 0x0020(0x0004) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		struct FInputScaleBiasClampConstants                       __StructProperty_73;                                     // 0x0024(0x002C) BlueprintVisible, NoDestructor
		float                                                      __FloatProperty_74;                                      // 0x0050(0x0004) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_LSJ8[0x1];                                   // 0x005B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		struct FAnimNodeFunctionRef                                __StructProperty_82;                                     // 0x0070(0x0020) BlueprintVisible, NoDestructor
	...
	/**
	 * ScriptStruct BPA_NobeliskBomb_ShockWave_02.BPA_NobeliskBomb_ShockWave_02_C.AnimBlueprintGeneratedMutableData
	 * Size -> 0x0000 (FullSize[0x0001] - InheritedSize[0x0001])
	 */
	struct UBPA_NobeliskBomb_ShockWave_02_C_FAnimBlueprintGeneratedMutableData : public FAnimBlueprintMutableData
	{	};
