...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_YPBA[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_S2II[0x7];                                   // 0x0089(0x0007) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_E2VS[0x7];                                   // 0x0031(0x0007) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_LL13[0x1];                                   // 0x0000(0x0001) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_F6HC[0x1];                                   // 0x0000(0x0001) MISSED OFFSET (PADDING)
	};
