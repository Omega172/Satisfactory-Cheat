...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_BMFD[0x4];                                   // 0x076C(0x0004) Fix Super Size
		unsigned char                                              UnknownData_ATQ7[0x18];                                  // 0x0770(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		bool                                                       UnknownData_49D0 : 2;                                    // 0x07B0(0x0001) BIT_FIELD (PADDING)
		...
		unsigned char                                              UnknownData_CDB3[0xF];                                   // 0x07B1(0x000F) MISSED OFFSET (PADDING)
