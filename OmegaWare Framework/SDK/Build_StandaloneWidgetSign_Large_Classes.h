...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Build_StandaloneWidgetSign_Large.Build_StandaloneWidgetSign_Large_C
	 * Size -> 0x0010 (FullSize[0x07A0] - InheritedSize[0x0790])
	 */
	class ABuild_StandaloneWidgetSign_Large_C : public AFGBuildableWidgetSign
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_Build_StandaloneWidgetSign_Large(int32_t EntryPoint);
