...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_OA6E[0x130];                                 // 0x0048(0x0130) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_L77L[0x5];                                   // 0x017B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8H8O[0x6];                                   // 0x0192(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<struct FActorLayer>                                 ActorLayers;                                             // 0x0198(0x0010) Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_I9D1[0x10];                                  // 0x01A8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_25T8[0x58];                                  // 0x01E0(0x0058) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_GXPU[0x7];                                   // 0x0239(0x0007) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_I2ES[0x20];                                  // 0x0048(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_8OFP[0x6];                                   // 0x006A(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_TPGV[0x7];                                   // 0x0069(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_8NZP[0x60];                                  // 0x0058(0x0060) MISSED OFFSET (PADDING)
