...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_UnlockBuildEfficiency.BP_UnlockBuildEfficiency_C.GetCost
	 */
	struct UBP_UnlockBuildEfficiency_C_GetCost_Params
	{
	public:
		...
		unsigned char                                              UnknownData_TRVM[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	{
	public:
		unsigned char                                              UnknownData_G98U[0x50];                                  // 0x0000(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
