...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass BPW_SignTest.BPW_SignTest_C
	 * Size -> 0x002F (FullSize[0x0458] - InheritedSize[0x0429])
	 */
	class UBPW_SignTest_C : public UBPW_SignPrefab_C
	{
	public:
		unsigned char                                              UnknownData_CRWQ[0x7];                                   // 0x0429(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class URichTextBlock*                                      mDescription;                                            // 0x0438(0x0008) BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		class UInvalidationBox*                                    mInvalidationBox;                                        // 0x0448(0x0008) BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
