...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Build_FoundationPassthrough_Hypertube.Build_FoundationPassthrough_Hypertube_C
	 * Size -> 0x0028 (FullSize[0x06A8] - InheritedSize[0x0680])
	 */
	class ABuild_FoundationPassthrough_Hypertube_C : public AFGBuildablePassthroughPipeHyper
	{
	public:
