...
namespace CG
{
	...
	/**
	 * Function Char_Stinger.Char_Stinger_C.NotifyOnTakeDamage
	 */
	struct AChar_Stinger_C_NotifyOnTakeDamage_Params
	{
	public:
		...
		unsigned char                                              UnknownData_I16X[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
