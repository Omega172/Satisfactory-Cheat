...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_UnlockCheckmark.BP_UnlockCheckmark_C.GetStingerWidgetRewardData
	 */
	struct UBP_UnlockCheckmark_C_GetStingerWidgetRewardData_Params
	{	};

	/**
	 * Function BP_UnlockCheckmark.BP_UnlockCheckmark_C.GetUnlockRewardWidgets
	 */
	struct UBP_UnlockCheckmark_C_GetUnlockRewardWidgets_Params
	{
	public:
	...
	/**
	 * Function BP_UnlockCheckmark.BP_UnlockCheckmark_C.GetUnlockDataStruct
	 */
	struct UBP_UnlockCheckmark_C_GetUnlockDataStruct_Params
	{
	public:
	...
	/**
	 * Function BP_UnlockCheckmark.BP_UnlockCheckmark_C.GetCost
	 */
	struct UBP_UnlockCheckmark_C_GetCost_Params
	{
	public:
		...
		unsigned char                                              UnknownData_F8SZ[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
