...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_THPF[0x4];                                   // 0x05CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_FHGD[0x7];                                   // 0x2DE9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
