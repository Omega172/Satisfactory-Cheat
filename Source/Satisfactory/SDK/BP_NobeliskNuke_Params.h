...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_NobeliskNuke.BP_NobeliskNuke_C.ShouldSave
	 */
	struct ABP_NobeliskNuke_C_ShouldSave_Params
	{
	public:
	...
	/**
	 * Function BP_NobeliskNuke.BP_NobeliskNuke_C.GatherDependencies
	 */
	struct ABP_NobeliskNuke_C_GatherDependencies_Params
	{
	public:
	...
	/**
	 * Function BP_NobeliskNuke.BP_NobeliskNuke_C.NeedTransform
	 */
	struct ABP_NobeliskNuke_C_NeedTransform_Params
	{
	public:
		bool                                                       ReturnValue;                                             // 0x0000(0x0001)  (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	...
	/**
	 * Function BP_NobeliskNuke.BP_NobeliskNuke_C.PlayExplosionEffects
	 */
	struct ABP_NobeliskNuke_C_PlayExplosionEffects_Params
	{	};

	/**
	 * Function BP_NobeliskNuke.BP_NobeliskNuke_C.ReceiveHit
	 */
	struct ABP_NobeliskNuke_C_ReceiveHit_Params
	{
	public:
		...
		unsigned char                                              UnknownData_JQUP[0x7];                                   // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_NobeliskNuke.BP_NobeliskNuke_C.OnImpact
	 */
	struct ABP_NobeliskNuke_C_OnImpact_Params
	{
	public:
	...
	/**
	 * Function BP_NobeliskNuke.BP_NobeliskNuke_C.ExecuteUbergraph_BP_NobeliskNuke
	 */
	struct ABP_NobeliskNuke_C_ExecuteUbergraph_BP_NobeliskNuke_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_KVK0[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
