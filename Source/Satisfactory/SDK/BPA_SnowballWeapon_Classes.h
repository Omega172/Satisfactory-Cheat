...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass BPA_SnowballWeapon.BPA_SnowballWeapon_C
	 * Size -> 0x0BA0 (FullSize[0x0EE8] - InheritedSize[0x0348])
	 */
	class UBPA_SnowballWeapon_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_QSPR[0x8];                                   // 0x0348(0x0008) Fix Super Size
	...
	public:
		...
		void ExecuteUbergraph_BPA_SnowballWeapon(int32_t EntryPoint);
