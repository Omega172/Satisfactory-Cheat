...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_XN0X[0x8];                                   // 0x0348(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_OXKI[0x7];                                   // 0x05C9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
