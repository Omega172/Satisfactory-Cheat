...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BPW_GenericDropArea.BPW_GenericDropArea_C.SetIsDropAreaActive
	 */
	struct UBPW_GenericDropArea_C_SetIsDropAreaActive_Params
	{
	public:
		bool                                                       mIsDropAreaActive;                                       // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};

	/**
	 * Function BPW_GenericDropArea.BPW_GenericDropArea_C.OnDrop
	 */
	struct UBPW_GenericDropArea_C_OnDrop_Params
	{
	public:
	...
	/**
	 * Function BPW_GenericDropArea.BPW_GenericDropArea_C.OnObjectDropped__DelegateSignature
	 */
	struct UBPW_GenericDropArea_C_OnObjectDropped__DelegateSignature_Params
	{
	public:
