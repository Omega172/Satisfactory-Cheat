...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Char_SpitterForestAlpha.Char_SpitterForestAlpha_C
	 * Size -> 0x0018 (FullSize[0x0A98] - InheritedSize[0x0A80])
	 */
	class AChar_SpitterForestAlpha_C : public ABP_Creature_C
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_Char_SpitterForestAlpha(int32_t EntryPoint);
