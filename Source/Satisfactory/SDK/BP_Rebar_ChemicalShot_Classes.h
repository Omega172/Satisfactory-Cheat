...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Rebar_ChemicalShot.BP_Rebar_ChemicalShot_C
	 * Size -> 0x0048 (FullSize[0x0620] - InheritedSize[0x05D8])
	 */
	class ABP_Rebar_ChemicalShot_C : public AFGProjectile
	{
	public:
		unsigned char                                              UnknownData_D4Y2[0x8];                                   // 0x05D8(0x0008) Fix Super Size
	...
	public:
		...
		void ExecuteUbergraph_BP_Rebar_ChemicalShot(int32_t EntryPoint);
