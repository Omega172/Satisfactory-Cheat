...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function Build_WorkBench.Build_WorkBench_C.IsEquipmentWorkshop
	 */
	struct ABuild_WorkBench_C_IsEquipmentWorkshop_Params
	{
	public:
	...
	/**
	 * Function Build_WorkBench.Build_WorkBench_C.CanDismantle
	 */
	struct ABuild_WorkBench_C_CanDismantle_Params
	{
	public:
		bool                                                       ReturnValue;                                             // 0x0000(0x0001)  (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_UOYH[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
