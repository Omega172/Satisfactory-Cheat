...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Char_SpitterDesertSmall.Char_SpitterDesertSmall_C
	 * Size -> 0x0010 (FullSize[0x0A90] - InheritedSize[0x0A80])
	 */
	class AChar_SpitterDesertSmall_C : public ABP_Creature_C
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_Char_SpitterDesertSmall(int32_t EntryPoint);
