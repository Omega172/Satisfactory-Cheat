...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_NobeliskGas.BP_NobeliskGas_C.ShouldSave
	 */
	struct ABP_NobeliskGas_C_ShouldSave_Params
	{
	public:
	...
	/**
	 * Function BP_NobeliskGas.BP_NobeliskGas_C.GatherDependencies
	 */
	struct ABP_NobeliskGas_C_GatherDependencies_Params
	{
	public:
	...
	/**
	 * Function BP_NobeliskGas.BP_NobeliskGas_C.NeedTransform
	 */
	struct ABP_NobeliskGas_C_NeedTransform_Params
	{
	public:
		bool                                                       ReturnValue;                                             // 0x0000(0x0001)  (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	...
	/**
	 * Function BP_NobeliskGas.BP_NobeliskGas_C.PlayExplosionEffects
	 */
	struct ABP_NobeliskGas_C_PlayExplosionEffects_Params
	{	};

	/**
	 * Function BP_NobeliskGas.BP_NobeliskGas_C.ReceiveHit
	 */
	struct ABP_NobeliskGas_C_ReceiveHit_Params
	{
	public:
		...
		unsigned char                                              UnknownData_HTXR[0x7];                                   // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_NobeliskGas.BP_NobeliskGas_C.OnExplode
	 */
	struct ABP_NobeliskGas_C_OnExplode_Params
	{	};

	/**
	 * Function BP_NobeliskGas.BP_NobeliskGas_C.OnImpact
	 */
	struct ABP_NobeliskGas_C_OnImpact_Params
	{
	public:
	...
	/**
	 * Function BP_NobeliskGas.BP_NobeliskGas_C.ExecuteUbergraph_BP_NobeliskGas
	 */
	struct ABP_NobeliskGas_C_ExecuteUbergraph_BP_NobeliskGas_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_41ZK[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
