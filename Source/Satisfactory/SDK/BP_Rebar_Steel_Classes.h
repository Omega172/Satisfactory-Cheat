...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Rebar_Steel.BP_Rebar_Steel_C
	 * Size -> 0x0048 (FullSize[0x0620] - InheritedSize[0x05D8])
	 */
	class ABP_Rebar_Steel_C : public AFGProjectile
	{
	public:
		unsigned char                                              UnknownData_PJH3[0x8];                                   // 0x05D8(0x0008) Fix Super Size
	...
	public:
		...
		void ExecuteUbergraph_BP_Rebar_Steel(int32_t EntryPoint);
