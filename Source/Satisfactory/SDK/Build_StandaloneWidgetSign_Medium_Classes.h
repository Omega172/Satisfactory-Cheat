...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Build_StandaloneWidgetSign_Medium.Build_StandaloneWidgetSign_Medium_C
	 * Size -> 0x0018 (FullSize[0x07A8] - InheritedSize[0x0790])
	 */
	class ABuild_StandaloneWidgetSign_Medium_C : public AFGBuildableWidgetSign
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_Build_StandaloneWidgetSign_Medium(int32_t EntryPoint);
