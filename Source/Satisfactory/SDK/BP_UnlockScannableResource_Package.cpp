...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x4C54A63A0
	 * 		Name   -> Function BP_UnlockScannableResource.BP_UnlockScannableResource_C.GetCost
	 ...
	 */
	void UBP_UnlockScannableResource_C::GetCost(int32_t UnlockStructIndex, TArray<struct FItemAmount>* cost)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_UnlockScannableResource.BP_UnlockScannableResource_C.GetCost");
		
		UBP_UnlockScannableResource_C_GetCost_Params params {};
	 ...
	 * Function:
	 * 		RVA    -> 0x4C54A63A0
	 * 		Name   -> Function BP_UnlockScannableResource.BP_UnlockScannableResource_C.GetUnlockDataStruct
	...
	void UBP_UnlockScannableResource_C::GetUnlockDataStruct(TArray<struct FFUnlockDataStruct>* UnlockDataStruct)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_UnlockScannableResource.BP_UnlockScannableResource_C.GetUnlockDataStruct");
	 ...
	 * Function:
	 * 		RVA    -> 0x4C54A63A0
	 * 		Name   -> Function BP_UnlockScannableResource.BP_UnlockScannableResource_C.GetStingerWidgetRewardData
	 * 		Flags  -> (Public, HasOutParms, HasDefaults, BlueprintCallable, BlueprintEvent)
	 */
	void UBP_UnlockScannableResource_C::GetStingerWidgetRewardData()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_UnlockScannableResource.BP_UnlockScannableResource_C.GetStingerWidgetRewardData");
	 ...
	 * Function:
	 * 		RVA    -> 0x4C54A63A0
	 * 		Name   -> Function BP_UnlockScannableResource.BP_UnlockScannableResource_C.GetUnlockRewardWidgets
	 * 		Flags  -> (Public, HasOutParms, HasDefaults, BlueprintCallable, BlueprintEvent)
	 * Parameters:
	...
	void UBP_UnlockScannableResource_C::GetUnlockRewardWidgets(class APlayerController* OwningPlayer, class UClass* SchematicClass, class UUserWidget* TradingPostWidget, TArray<class UUserWidget*>* Widgets)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_UnlockScannableResource.BP_UnlockScannableResource_C.GetUnlockRewardWidgets");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UBP_UnlockScannableResource_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UBP_UnlockScannableResource_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass BP_UnlockScannableResource.BP_UnlockScannableResource_C");
		return ptr;
	}
