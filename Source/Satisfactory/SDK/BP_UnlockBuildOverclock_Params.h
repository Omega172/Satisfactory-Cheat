...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_UnlockBuildOverclock.BP_UnlockBuildOverclock_C.GetCost
	 */
	struct UBP_UnlockBuildOverclock_C_GetCost_Params
	{
	public:
		...
		unsigned char                                              UnknownData_XZUR[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		TArray<struct FItemAmount>                                 cost;                                                    // 0x0008(0x0010)  (Parm, OutParm)
	};

	/**
	 * Function BP_UnlockBuildOverclock.BP_UnlockBuildOverclock_C.GetUnlockDataStruct
	 */
	struct UBP_UnlockBuildOverclock_C_GetUnlockDataStruct_Params
	{
	public:
	...
	/**
	 * Function BP_UnlockBuildOverclock.BP_UnlockBuildOverclock_C.GetStingerWidgetRewardData
	 */
	struct UBP_UnlockBuildOverclock_C_GetStingerWidgetRewardData_Params
	{
	public:
		unsigned char                                              UnknownData_WFS8[0x50];                                  // 0x0000(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function BP_UnlockBuildOverclock.BP_UnlockBuildOverclock_C.GetUnlockRewardWidgets
	 */
	struct UBP_UnlockBuildOverclock_C_GetUnlockRewardWidgets_Params
	{
	public:
