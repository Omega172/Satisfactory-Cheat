...
namespace CG
{
	...
	{
	public:
		class UStaticMeshComponent*                                SM_JumpingStilts_L;                                      // 0x0340(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash
