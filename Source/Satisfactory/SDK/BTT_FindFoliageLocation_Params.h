...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BTT_FindFoliageLocation.BTT_FindFoliageLocation_C.ReceiveExecute
	 */
	struct UBTT_FindFoliageLocation_C_ReceiveExecute_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_63Q1[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
