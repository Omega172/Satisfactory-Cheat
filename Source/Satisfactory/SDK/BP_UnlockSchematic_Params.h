...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_UnlockSchematic.BP_UnlockSchematic_C.GetCost
	 */
	struct UBP_UnlockSchematic_C_GetCost_Params
	{
	public:
		...
		unsigned char                                              UnknownData_HO00[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
