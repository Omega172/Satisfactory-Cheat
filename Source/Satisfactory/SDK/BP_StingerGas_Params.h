...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_StingerGas.BP_StingerGas_C.PlaySFXAtLocation
	 */
	struct ABP_StingerGas_C_PlaySFXAtLocation_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_MNLF[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
