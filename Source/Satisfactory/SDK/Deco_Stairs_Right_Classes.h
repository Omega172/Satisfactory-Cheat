...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Deco_Stairs_Right.Deco_Stairs_Right_C
	 * Size -> 0x0030 (FullSize[0x0330] - InheritedSize[0x0300])
	 */
	class ADeco_Stairs_Right_C : public AFGDecorationTemplate
	{
	public:
		...
		class UFGAttachmentPointComponent*                         AttachmentPoint_CornerLeft;                              // 0x0308(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash
