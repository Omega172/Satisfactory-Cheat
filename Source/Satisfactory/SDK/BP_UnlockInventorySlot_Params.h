...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_UnlockInventorySlot.BP_UnlockInventorySlot_C.GetCost
	 */
	struct UBP_UnlockInventorySlot_C_GetCost_Params
	{
	public:
		...
		unsigned char                                              UnknownData_6XJG[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		TArray<struct FItemAmount>                                 cost;                                                    // 0x0008(0x0010)  (Parm, OutParm)
	};

	/**
	 * Function BP_UnlockInventorySlot.BP_UnlockInventorySlot_C.GetUnlockDataStruct
	 */
	struct UBP_UnlockInventorySlot_C_GetUnlockDataStruct_Params
	{
	public:
	...
	/**
	 * Function BP_UnlockInventorySlot.BP_UnlockInventorySlot_C.GetStingerWidgetRewardData
	 */
	struct UBP_UnlockInventorySlot_C_GetStingerWidgetRewardData_Params
	{
	public:
		unsigned char                                              UnknownData_378K[0x50];                                  // 0x0000(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function BP_UnlockInventorySlot.BP_UnlockInventorySlot_C.GetUnlockRewardWidgets
	 */
	struct UBP_UnlockInventorySlot_C_GetUnlockRewardWidgets_Params
	{
	public:
