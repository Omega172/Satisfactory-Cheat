...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass BPA_GeneratorGeoThermal.BPA_GeneratorGeoThermal_C
	 * Size -> 0x0170 (FullSize[0x0E10] - InheritedSize[0x0CA0])
	 */
	class UBPA_GeneratorGeoThermal_C : public UFGFAnimInstanceFactory
	{
	public:
		struct FPointerToUberGraphFrame                            UberGraphFrame;                                          // 0x0CA0(0x0008) ZeroConstructor, Transient, DuplicateTransient
		struct UBPA_GeneratorGeoThermal_C_FAnimBlueprintGeneratedMutableData __AnimBlueprintMutables;                                 // 0x0CA8(0x0008) HasGetValueTypeHash
	...
	public:
		...
		void ExecuteUbergraph_BPA_GeneratorGeoThermal(int32_t EntryPoint);
