...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function Context_GetInvestigationLocation.Context_GetInvestigationLocation_C.ProvideSingleLocation
	 */
	struct UContext_GetInvestigationLocation_C_ProvideSingleLocation_Params
	{
	public:
