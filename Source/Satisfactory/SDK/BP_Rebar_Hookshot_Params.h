...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Rebar_Hookshot.BP_Rebar_Hookshot_C.ReceiveHit
	 */
	struct ABP_Rebar_Hookshot_C_ReceiveHit_Params
	{
	public:
		...
		unsigned char                                              UnknownData_YUJQ[0x7];                                   // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_Rebar_Hookshot.BP_Rebar_Hookshot_C.Shot Player
	 */
	struct ABP_Rebar_Hookshot_C_ShotPlayer_Params
	{
	public:
	...
	/**
	 * Function BP_Rebar_Hookshot.BP_Rebar_Hookshot_C.Grapple Launch
	 */
	struct ABP_Rebar_Hookshot_C_GrappleLaunch_Params
	{	};

	/**
	 * Function BP_Rebar_Hookshot.BP_Rebar_Hookshot_C.Attach cable
	 */
	struct ABP_Rebar_Hookshot_C_Attachcable_Params
	{	};

	/**
	 * Function BP_Rebar_Hookshot.BP_Rebar_Hookshot_C.ReceiveBeginPlay
	 */
	struct ABP_Rebar_Hookshot_C_ReceiveBeginPlay_Params
	{	};

	/**
	 * Function BP_Rebar_Hookshot.BP_Rebar_Hookshot_C.ReceiveTick
	 */
	struct ABP_Rebar_Hookshot_C_ReceiveTick_Params
	{
	public:
	...
	/**
	 * Function BP_Rebar_Hookshot.BP_Rebar_Hookshot_C.PlayAttachEffect
	 */
	struct ABP_Rebar_Hookshot_C_PlayAttachEffect_Params
	{	};

	/**
	 * Function BP_Rebar_Hookshot.BP_Rebar_Hookshot_C.ExecuteUbergraph_BP_Rebar_Hookshot
	 */
	struct ABP_Rebar_Hookshot_C_ExecuteUbergraph_BP_Rebar_Hookshot_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_807Q[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
