...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_UnlockScannableResource.BP_UnlockScannableResource_C.GetCost
	 */
	struct UBP_UnlockScannableResource_C_GetCost_Params
	{
	public:
		...
		unsigned char                                              UnknownData_6YYL[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct UBP_UnlockScannableResource_C_GetUnlockDataStruct_Params
	{
	public:
	 ...
	 */
	struct UBP_UnlockScannableResource_C_GetStingerWidgetRewardData_Params
	{
	public:
		unsigned char                                              UnknownData_Y1T2[0x50];                                  // 0x0000(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function BP_UnlockScannableResource.BP_UnlockScannableResource_C.GetUnlockRewardWidgets
	 */
	struct UBP_UnlockScannableResource_C_GetUnlockRewardWidgets_Params
	{
	public:
