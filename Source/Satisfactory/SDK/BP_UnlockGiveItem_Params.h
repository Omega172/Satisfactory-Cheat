...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_UnlockGiveItem.BP_UnlockGiveItem_C.GetCost
	 */
	struct UBP_UnlockGiveItem_C_GetCost_Params
	{
	public:
		...
		unsigned char                                              UnknownData_CB9Y[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
